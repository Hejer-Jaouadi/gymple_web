...
class MembershipController extends AbstractController
{
    ...
    /**
     * @Route("/{idm}", name="app_membership_show", methods={"GET"})
     */
    ...
    /**
     * @Route("/{idm}/edit", name="app_membership_edit", methods={"GET", "POST"})
     */
    ...
    /**
     * @Route("/{idm}", name="app_membership_delete", methods={"POST"})
     */
    public function delete(Request $request, Membership $membership, EntityManagerInterface $entityManager): Response
    {
        if ($this->isCsrfTokenValid('delete'.$membership->getIdm(), $request->request->get('_token'))) {
